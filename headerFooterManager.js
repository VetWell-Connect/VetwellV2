class SpecialHeader extends HTMLElement {
    ConnectedCallback() {
        ...
        <header id="header" class="header d-flex align-items-center sticky-top">
            ...
            <a class="btn-getstarted" href="reviews.html">Get Started</a>
...
class SpecialFooter extends HTMLElement {
    connectedCallback() {
        ...
        <footer id="footer" class="footer position-relative">
            ...
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6 footer-discover">
                ...
                <p>Subscribe to our newsletter and receive the latest news discover our products and services!</p>
